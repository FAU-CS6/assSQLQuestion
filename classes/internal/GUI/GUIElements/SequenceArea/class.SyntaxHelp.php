...
/**
 * Represents the syntax help GUIElement
 *
 * @author Marco Angerer <marco.angerer@fau.de>
 */
class SyntaxHelp extends GUIElement
{
    /**
    ...
    {
        $tpl = $this->plugin->getTemplate('Mixed/tpl.il_as_qpl_qpisql_m_syntax_help.html');
        $tpl->setVariable("TITLE", $this->plugin->txt('ai_sea_eo_syntax_help_title'));
        $tpl->setVariable("TEXT", $this->plugin->txt('ai_sea_eo_syntax_help_text'));
        return $tpl->get();
    }
